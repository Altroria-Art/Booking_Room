...
import { fetchRoomTypes, createRoom } from "@/services/api" 
// ถ้า alias ใช้ไม่ได้ ให้เปลี่ยนเป็น: import { fetchRoomTypes, createRoom } from "../../services/api"
...
.sheet{ width:min(520px,92vw); background:#dfe4ff; border-radius:24px; box-shadow:0 20px 50px rgba(0,0,0,.35); padding:28px 24px; }
...
.control{ width:100%; box-sizing:border-box; display:block; padding:12px 14px; border-radius:10px; border:1px solid #cbd5e1; background:#fff; }
...
.success{ background:#7dfc90; color:#111; }
